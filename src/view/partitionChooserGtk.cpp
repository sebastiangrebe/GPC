...
void PartitionChooserGtk::init(bool useExisting){
	...
	if (!this->assistant){
		...
		this->assistant->set_page_title(vbIntroPage, gettext("GPC: Partition chooser"));
		this->assistant->set_icon_name("gpc");
		...
		this->assistant->set_title(Glib::ustring("GPC: ")+gettext("Partition Chooser"));
		this->assistant->set_icon_name("gpc");
